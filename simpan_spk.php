...
$sql = $conn->query("insert into spk(id_pengguna,no_spk,judul_buku,no_isbn,tanggal,tanggal_permintaan_selesai,oplah_cetak,oplah_insheet,ukuran_buku,jumlah_halaman,jumlah_catern,
jumlah_plat,ukuran_kertas,kebutuhan_kertas,mesin_cetak) 
values('$idp','$no_spk','$judul_buku','$no_isbn','$tanggal','$tanggal_permintaan_selesai','$oplah_cetak','$oplah_insheet','$ukuran_buku','$jumlah_halaman','$jumlah_catern',
'$jumlah_plat','$ukuran_kertas','$kebutuhan_kertas','$mesin_cetak')");
if ($sql) {
