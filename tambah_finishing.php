...
<body id="page-top">
    <div class="card shadow">
        <div class="card-header">
            Form Tambah Laporan Unit Finishing
            <form action="simpan_finishing.php" method="post" class="form-horizontal">
        </div>
        <div class="form-row">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <br>
                <input type="text" name="jumlah_gabung" class="form-control">
            </div>
        </div>
        <br>
        <div class="form-group">
