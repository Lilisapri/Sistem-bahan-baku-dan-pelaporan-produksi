                ...
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" action="simpan_eoq.php" method="post">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control" id="id_bahan_baku" name="id_bahan_baku" required>
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            echo '<option value="' . $row['id'] . '">' . $row['kode_bahan_baku'] . ' - ' . $row['nama'] . '</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                <label for="biaya_pesanan_per_order" class="col-sm-4 col-form-label">Biaya Pesanan</label>
                                <div class="col-sm-8">
                                    <input type="number" class="form-control" id="biaya_pesanan_per_order" name="biaya_pesanan_per_order" placeholder="Input biaya pesanan" required>
                                </div>
                            </div>
                            <div class="form-group row">
