  ...
  <div class="container">
    <div class="card shadow my-5">
      <div class="card-header">
        Form Edit Unit Finishing
      </div>
      <div class="card-body">
        <?php 
          require 'koneksi.php';
          $sql=$conn->query("select * from unit_finishing where id='$_GET[id]'");
          $data = $sql->fetch_assoc();
        ?>
        <form action="update_finishing.php" method="post" class="form-horizontal">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>Id Unit Finishing</label>
              ...
              <div class="form-group">
                ...
                <select name="id_unit_kerja" class="form-control">
                    <?php
                    include 'koneksi.php';
                    $sql_unit_kerja = $conn->query("SELECT * FROM unit_kerja WHERE jenis_unit_kerja = 'Unit Finishing'");
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                <label>Jumlah Gabung</label>
                <input type="text" name="jumlah_gabung" class="form-control" value="<?php echo $data['jumlah_gabung'];?>">
              </div>
            </div>
          </div>
          <div class="form-group">
            <input type="submit" class="btn btn-primary" value="Update Unit Finishing">
          </div>
        </form>
      </div>
    </div>
