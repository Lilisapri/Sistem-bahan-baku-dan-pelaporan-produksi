  ...
  <div class="container">
    <div class="card shadow">
      <div class="card-header">
        Form Edit Unit Stahl
      </div>
      <div class="card-body">
        <?php 
          require 'koneksi.php';
          $sql = $conn->query("SELECT * FROM unit_stahl WHERE id='$_GET[id]'");
          $data = $sql->fetch_assoc();
        ?>
        <form action="update_stahl.php" method="post" class="form-horizontal">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label>id unit stahl</label>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input type="text" name="hasil_lipat" class="form-control" value="<?php echo $data['hasil_lipat'];?>">
              </div>
              <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Update Unit Stahl">
              </div>
            </div>
          </div>
        </form>
