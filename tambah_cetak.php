...
<body Id="page-top">
	...
	<div class="card shadow">
		<div class="card-header">
			Form Tambah Laporan Unit Cetak

			<form action="simpan_cetak.php" method="post" class="form-herizontal">
		</div>
		...
		<div class="form-group col-sm-4">
			...
			<br>
			<input type="text" name="total_catern" class="form-control">
		</div>

		<div class="form-group col-sm-4">
			<label>Total plat</label>
			<br>
			<input type="text" name="total_plat" class="form-control">
		</div>

		<div class="form-group col-sm-4">
			<label>Total Lembar</label>
			<br>
			<input type="text" name="total_lembar" class="form-control">
		</div>
