...
<body id="bg-gradient-primary">
    <div class="card shadow">
        <div class="card-header">
            Form Edit Unit Packing
        </div>
        <div class="card-body">
            <?php 
            require 'koneksi.php';
            $sql = $conn->query("SELECT * FROM unit_packing WHERE id='$_GET[id]'");
            $data = $sql->fetch_assoc();
            ?>
            <form action="update_packing.php" method="post" class="form-horizontal">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Id Unit Packing</label>
                        ...
                        <?php
                        include 'koneksi.php';
                        $sql_unit_kerja = $conn->query("SELECT * FROM unit_kerja WHERE jenis_unit_kerja = 'Unit Packing'");
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="total_buku" class="form-control" value="<?php echo $data['total_buku'];?>">
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn btn-primary" value="Update Unit Packing">
                        </div>
                    </div>
                </div>
            </form>
